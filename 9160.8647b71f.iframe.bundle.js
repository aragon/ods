...
`,blocks_T=({children:e,collapsable:o=!0,defaultCollapsed:t=!1,placeholder:r,showLink:n=!0,onCollapsedChange:s,...a})=>{let[l,u]=(0,react.useState)(!!t),F=n&&"url"in a;return react.createElement(lo,null,react.createElement(mo,{collapsed:o&&l,...a},o&&l?react.createElement(po,null,r):e,react.createElement(chunk_WDXN43AK.E7,{actionItems:[o&&{title:l?"Show":"Hide",onClick:()=>{let c=!l;s&&s(c,l),u(c)}},F&&{title:"Open in new tab",onClick:()=>window.open(a.url,"_blank")}].filter((c=>!!c))})))},or=({placeholder:e,...o})=>react.createElement(blocks_T,{placeholder:e??"Design (Figma)",...o},react.createElement(blocks_B,{config:{type:"figma",...o}}));dist.I4.div`
  ...
  overflow: auto;
`}}]);
//# sourceMappingURL=9160.8647b71f.iframe.bundle.js.map