...
module.exports = {
    ...
    theme: {
        ...
        boxShadow: {
            neutral: {
                sm: 'var(--ods-shadow-neutral-sm)',
                DEFAULT: 'var(--ods-shadow-neutral)',
                md: 'var(--ods-shadow-neutral-md)',
                lg: 'var(--ods-shadow-neutral-lg)',
                xl: 'var(--ods-shadow-neutral-xl)',
                '2xl': 'var(--ods-shadow-neutral-2xl)',
            },
            primary: {
                sm: 'var(--ods-shadow-primary-sm)',
                DEFAULT: 'var(--ods-shadow-primary)',
                md: 'var(--ods-shadow-primary-md)',
                lg: 'var(--ods-shadow-primary-lg)',
                xl: 'var(--ods-shadow-primary-xl)',
                '2xl': 'var(--ods-shadow-primary-2xl)',
            },
            success: {
                sm: 'var(--ods-shadow-success-sm)',
                DEFAULT: 'var(--ods-shadow-success)',
                md: 'var(--ods-shadow-success-md)',
                lg: 'var(--ods-shadow-success-lg)',
                xl: 'var(--ods-shadow-success-xl)',
                '2xl': 'var(--ods-shadow-success-2xl)',
            },
            warning: {
                sm: 'var(--ods-shadow-warning-sm)',
                DEFAULT: 'var(--ods-shadow-warning)',
                md: 'var(--ods-shadow-warning-md)',
                lg: 'var(--ods-shadow-warning-lg)',
                xl: 'var(--ods-shadow-warning-xl)',
                '2xl': 'var(--ods-shadow-warning-2xl)',
            },
            critical: {
                sm: 'var(--ods-shadow-critical-sm)',
                DEFAULT: 'var(--ods-shadow-critical)',
                md: 'var(--ods-shadow-critical-md)',
                lg: 'var(--ods-shadow-critical-lg)',
                xl: 'var(--ods-shadow-critical-xl)',
                '2xl': 'var(--ods-shadow-critical-2xl)',
            },
        },
        screens: {
