...
export const DataListItem: React.FC<IDataListItemProps> = (props) => {
    ...
    const hasValidLink = href == null || href === '';
    ...
    const actionItemClasses = classNames(
        ...
        { 'hover:border-neutral-200 hover:shadow-neutral-md active:border-neutral-300': !hasValidLink }, // Valid link & hover states
        { 'cursor-pointer': !hasValidLink }, // Valid link
