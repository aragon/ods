...
The provider also renders the `<OdsCoreProvider />` and passes the values set in the `coreProviderValues` property and
the values set in the `values` property for module-specific configurations.
